...
The purpose of this documentation is to give a detailed description of the requirements for the "Telematics" hardware and all of the software that comes with it. It shows the purpose and complete development process of the system. This also shows the system constraints, system interface and interactions with other external applications. This documentation is primarily intended for our professor and his approval as well as a reference for developing the system.

1.2 Scope
------------------------
The "Telematics" is a hardware that helps the police, insurance companies, and drivers to determine the cause of a car incident. The hardware will have 3 cameras (one for each sides and one on the rear). It will also have an android application where the user can review any previous incident that has happened and add more information if needed. 

Upon installing the hardware, the user has to register through the official website and enter the appropriate information and product key. From then on, the hardware will be able to send data to the database once it has connected to the internet. The hardware does not need to maintain a network connection in order to work. Once the car starts, it will start recording and will replace the old file with a new file until it detects an accident. Once the hardware detects an incident, it will lock the video file and will not be able to overwrite the data until it has successfully uploaded the data and video files to the server. Once the hardware is connected to the network, it will upload the video to the server including the information related to the incident such as date and the location of the incident.

Furthermore, the user will be able to access the information through their android phone. From there, they need to log in in order to retrieve the information related to their account. From there on, the user can review the incident and add information about the incident like, the driver's information and car information. If the user does not have an android phone, they can do everything that was mentioned before through the official website.
